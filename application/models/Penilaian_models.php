...
class Penilaian_models extends CI_Model
{
    ...
    public function get_data_nilai($id_kelas){
        $this->db->select('a.id, a.score, b.nama_murid, b.nisn,a.nilai_tugas, a.nilai_keaktifan,a.nilai_akhir');
    ...
    public function get_data_nilai_edit($id, $id_kelas){
        $this->db->select('a.id, a.score, a.id_siswa, a.id_penilaian, b.nama_murid, b.nisn, a.nilai_tugas, a.nilai_keaktifan,a.nilai_akhir');
        $this->db->from('tbl_penilaian_siswa a');
        $this->db->join('tb_murid b', 'a.id_siswa = b.id','left');
        $this->db->where('a.id_kelas', $id_kelas);
    ...
    public function get_data_nilai_per_siswa($id, $id_kelas){
        $this->db->select('a.id, a.score, a.id_siswa, a.id_penilaian, b.nama_murid, b.nisn, c.tgl,a.nilai_tugas,a.nilai_keaktifan,a.nilai_akhir');
        $this->db->from('tbl_penilaian_siswa a');
        $this->db->join('tb_murid b', 'a.id_siswa = b.id','left');
